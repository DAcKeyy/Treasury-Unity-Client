namespace Data
{
    public struct UnityTags
    {
        ...
        public const string HANDLE_TAG = "Handle";
        public const string ENEMY_SPAWN_POINT_TAG = "Enemy Spawn Point";
        public const string PALYER_SPAWN_POINT_TAG = "Player Spawn Point";
    }
    
    public struct AnimationTags
    {
        public const string SHOOT_TRIGGER = "Shoot";
        public const string CHARGE_TRIGGER = "Charge";
